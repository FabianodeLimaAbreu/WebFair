      ...
      if(13 === a.keyCode){
        ...
        if(0 < a.target.value.length){
          ...
          if(40 === a.keyCode || 38 === a.keyCode) {
            ...
            this.callService("combosearch",'<FORN_DESC>'+a.target.value.replaceSpecial()+'</FORN_DESC>','<FEIR_COD></FEIR_COD>','<LINHA_I>'+'1'+'</LINHA_I>','<LINHA_F>'+'60'+'</LINHA_F>','<CREATE_DATE_I>1900-10-17</CREATE_DATE_I>','');
          }
        }
        else{
