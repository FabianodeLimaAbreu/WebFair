...
open: function(a){
  ...
  if(result.length){
    ...
    this.callService("singleSample",'<FEIR_COD>14</FEIR_COD>','<AMOS_ID>141000108</AMOS_ID>','<LINHA_I>1</LINHA_I>','<LINHA_F>20000</LINHA_F>','<CREATE_DATE_I>2000-01-01</CREATE_DATE_I>','<CREATE_DATE_F>2020-10-10</CREATE_DATE_F>');
  }
},init:function() {
  this.item = null;
